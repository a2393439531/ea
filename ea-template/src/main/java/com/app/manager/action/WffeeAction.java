...
@Component("wffeeAction")
@SuppressWarnings("rawtypes")
public class WffeeAction extends BaseProcessAction {
	private static Logger log = LoggerFactory.getLogger(WffeeAction.class);
	...
	public String complete_task(){
		...
		if(modelStr != null && !"".equals(modelStr)){
			...
			Wffee pm = (Wffee)baseDao.loadById(modelStr, Long.parseLong(formId));
			pm.setCount(count);
			baseDao.update(pm);
		}
