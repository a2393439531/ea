...
public class MstopProcessTest {
	private final Logger log = LoggerFactory.getLogger(MstopProcessTest.class);
  @Autowired
  ...
  */
  ...
  public void deploy() throws FileNotFoundException {
	  infActiviti.deploy("com/app/manager/oa/bpmn/hello.bpmn20.xml");
	  /*
  ...
  public void RewardTaskProcessDeploy() throws FileNotFoundException {
	//  infActiviti.deploy("com/app/manager/oa/bpmn/RewardTaskProcess.bpmn");
	  infActiviti.deploy("src/main/resources/com/app/manager/oa/bpmn/RewardTaskProcess.bpmn");
