...
public class ProcessDiagramCanvas {
  ...
  protected static Font ANNOTATION_FONT = new Font("Microsoft Yahei Font", Font.PLAIN, FONT_SIZE);
  protected static Font TASK_FONT = new Font("Microsoft Yahei Font", Font.PLAIN, FONT_SIZE);
  ...
  protected String activityFontName = "Microsoft Yahei Font";  //不能认中文字体
  protected String labelFontName = "Microsoft Yahei Font";     //
  ...
  public ProcessDiagramCanvas(int width, int height) {
    ...
    LABEL_FONT = new Font("宋体", Font.ITALIC, 10);
  }
