...
public class PathUtils {
	public static String SYSTEM_DATA_CLASS="com.app.system.SystemData";
	/**
	 * 连接两个路径，例如：<br/>
	 * a : /abc/ <br/>
	 * b : /def <br/>
	 ...
	 */
	public static String getClassPath(String classfilepath) throws ClassNotFoundException {
	...
	public static String getWebrootPath(String classfilepath) {
		try {//"com.app.manager.init.SystemData"
			
			String classpath = getClassPath(classfilepath);
	...
	public static String getHomePath(String classfilepath) {
		try {
