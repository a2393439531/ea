 ...
 */
/*
如果在Hibernate层采用lazy=true的话，有的时候会抛出LazyInitializationException，
这时一种解决办法是用OpenSessionInViewFilter,但是如果通过main方法来运行一些测试程序，那么上述方法就没有用武之地了。这里提供了一种方法，来达到实现和OpenSessionInViewFilter相同作用的目的。这里的应用场景是采用JUnit4来编写测试用例。
 ...
 * */
public class AbstractTestSpringHibernate {
